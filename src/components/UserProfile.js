...
class UserProfile extends React.Component {
    state = {
        DialogOpen: false,
        userid: '', username: '', usermsg: '', userphoto: '', photourl: ''
    };
    ...
    componentDidMount() {
      ...
      firestore.collection("users").doc(this.props.uid).get()
          .then(doc => {
              const user = doc.data();
              _this.setState({
                  userid: user.userid, username: user.username, usermsg: user.usermsg, userphoto: user.userphoto, photourl: ''
              });
    ...
    handleSubmit = (e) => {
        ...
        let data = {
          userid: user.userid, username: user.username, usermsg: user.usermsg, userphoto: user.userphoto
        };
        const _this = this;
    ...
    return (
      <div>
        <form className={classes.container} noValidate autoComplete="off" onSubmit={this.handleSubmit}>
          ...
          <TextField label="Name" className={classes.textField} value={this.state.username} onChange={this.handleChange('username')} margin="normal" fullWidth/>
